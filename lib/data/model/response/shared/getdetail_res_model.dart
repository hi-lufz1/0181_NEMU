...
class GetdetailResModel {
  ...
  GetdetailResModel({this.status, this.message, this.data});

  factory GetdetailResModel.fromJson(String str) =>
      GetdetailResModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetdetailResModel.fromMap(Map<String, dynamic> json) =>
      GetdetailResModel(
        status: json["status"],
